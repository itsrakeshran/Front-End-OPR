...
const RfqListforEntry = ({ setCurrnetRfq, setShowItemForm }) => {
    ...
    const [cRfqNum, setRfqnum] = useState();
    ...
    const colDefs = [
        {
            ...
            cellRendererParams: {
                ...
                setForm: setShowItemForm,
                setRfq: setCurrnetRfq,

            },
            maxWidth: '200'
        },
        { field: 'rfq_num', headerName: 'Rfq Number' },
...
export default RfqListforEntry;
